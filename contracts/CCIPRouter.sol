...
import {MockedPool} from './MockedPool.sol';
...
contract CCIPRouter is CCIPReceiver, OwnerIsCreator {
    ...
    mapping(address => uint256) public howMuchDeposited;

    IERC20 private s_linkToken;
    
    address public socialContract;

    MockedPool public pool;
    ...
    modifier onlySocial() {
        require(msg.sender == socialContract);
        _;
    }
